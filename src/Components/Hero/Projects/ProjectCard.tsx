          ...
          <div className="flex gap-3 mt-6">
            ...
            {project?.demoLink === "#" ? (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2 bg-green-600  text-white text-sm font-medium rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20"
              >
                View Demo
              </button>
            ) : (
        ...
        <AnimatePresence>
          ...
          >
            <motion.div
              ...
              className="relative bg-[#1f1f28] rounded-lg p-6 w-[60%] h-[80vh] flex justify-center items-center shadow-xl text-white"
            >
              <button
                onClick={() => setOpen(false)}
                className="absolute top-3 right-3 cursor-pointer text-gray-300 hover:text-white"
              >
                <IoMdClose size={24} />
              </button>
